...
# Node
NODE_REPO=https://github.com/desmos-labs/desmos.git
NODE_VERSION=v5.2.0
NODE_REPO_FOLDER=desmos
NODE_DAEMON=desmos
NODE_ID=desmos-mainnet
NODE_DENOM=udsm
NODE_FOLDER=.desmos
NODE_GENESIS_ZIP=false
NODE_GENESIS_FILE=https://raw.githubusercontent.com/desmos-labs/mainnet/main/genesis.json
NODE_ADDR_BOOK=true
NODE_ADDR_BOOK_FILE=https://snapshots1.nodejumper.io/desmos/addrbook.json

# Service
NODE_SERVICE_NAME=desmos
...
# Snapshot
SNAPSHOT_PATH=https://snapshots1.nodejumper.io/desmos/desmos-mainnet_2023-07-16.tar.lz4
...
function installNode() {
  ...
  sudo mv $HOME/go/bin/$NODE_DAEMON /usr/local/bin
