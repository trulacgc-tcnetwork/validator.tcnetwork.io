...
# Node
NODE_REPO=https://github.com/sunriselayer/sunrise.git
NODE_VERSION=v1.0.0
NODE_REPO_FOLDER=sunrise
NODE_DAEMON=sunrised
NODE_ID=sunrise-1
NODE_DENOM=urise
NODE_FOLDER=.sunrise
NODE_GENESIS_ZIP=false
NODE_GENESIS_FILE=https://raw.githubusercontent.com/sunriselayer/network/main/sunrise-1/genesis.json
NODE_ADDR_BOOK=false
NODE_ADDR_BOOK_FILE=

# Service
NODE_SERVICE_NAME=sunrise
...
# Snapshot
SNAPSHOT_PATH=https://snapshots.polkachu.com/snapshots/sunrise/sunrise_97445.tar.lz4
...
function initNode() {
  ...
  # inbound/outbound
  sed -i 's/max_num_inbound_peers =.*/max_num_inbound_peers = 40/g' $CONFIG_PATH
