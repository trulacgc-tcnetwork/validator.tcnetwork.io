...
# Node
NODE_REPO=https://github.com/rebuschain/rebus.core.git
NODE_VERSION=v0.5.0
NODE_REPO_FOLDER=rebus.core
NODE_DAEMON=rebusd
NODE_ID=reb_1111-1
NODE_DENOM=arebus
NODE_FOLDER=.rebusd
NODE_GENESIS_ZIP=true
NODE_GENESIS_FILE=https://raw.githubusercontent.com/rebuschain/rebus.mainnet/master/reb_1111-1/genesis.zip
NODE_ADDR_BOOK=true
NODE_ADDR_BOOK_FILE=https://raw.githubusercontent.com/111STAVR111/props/main/Rebus/addrbook.json

# Service
NODE_SERVICE_NAME=rebus
...
# Snapshot
SNAPSHOT_PATH=https://rebus.snapshot.stavr.tech/rebus-snap.tar.lz4
...
function initNode() {
  ...
  curl $NODE_GENESIS_FILE >$HOME/$NODE_FOLDER/config/genesis.zip
  cd $HOME/$NODE_FOLDER/config/
  ...
  sed -i -e "s/^minimum-gas-prices *=.*/minimum-gas-prices = \"0.0008$NODE_DENOM\"/" $APP_PATH
