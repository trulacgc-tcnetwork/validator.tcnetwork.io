...
NODE_GENESIS_FILE=https://ss.nibiru.nodestake.org/genesis.json
NODE_ADDR_BOOK=true
NODE_ADDR_BOOK_FILE=https://ss.nibiru.nodestake.org/addrbook.json
...
# Snapshot
SNAPSHOT_PATH=https://snapshots.polkachu.com/snapshots/nibiru/nibiru_8862670.tar.lz4
...
function initNode() {
  ...
  # sed -i 's|seeds =.*|seeds = "'$(curl -s https://networks.nibiru.fi/$NODE_ID/seeds)'"|g' $CONFIG_PATH
