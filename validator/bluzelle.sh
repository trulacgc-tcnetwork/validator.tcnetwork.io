...
function installNode() {
  ...
  cd $HOME
  git clone $NODE_REPO $NODE_REPO_FOLDER
  cd $NODE_REPO_FOLDER
...
function initNode() {
  ...
  # peer
  PEERS="58fb5ba6e285a4b785c597f9ed480ced7bd06329@a.gateway.sentry.net.bluzelle.com:26656,ea7e48103d33356aa576b3d60cfabc250a7c2998@b.gateway.sentry.net.bluzelle.com:26656,70b5e2af27c5591967d7f1fea965b8627dd656e8@c.gateway.sentry.net.bluzelle.com:26656"
...
function installService() {
  ...
  User=$USER
  Type=simple
  ExecStart=$(which $NODE_DAEMON) start --home $HOME/$NODE_FOLDER
  Restart=on-failure
  RestartSec=3
  LimitNOFILE=65535
