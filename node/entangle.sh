...
# Node
NODE_VERSION=main
NODE_REPO=https://github.com/Entangle-Protocol/entangle-blockchain.git
NODE_REPO_FOLDER=entangle-blockchain
NODE_DAEMON=entangled
NODE_ID=entangle_33133-1
NODE_DENOM=aNGL
NODE_FOLDER=.entangled
NODE_GENESIS_ZIP=false
NODE_GENESIS_FILE=https://ss-t.entangle.nodestake.top/genesis.json
NODE_GENESIS_CHECKSUM=
NODE_ADDR_BOOK=true
NODE_ADDR_BOOK_FILE=https://ss-t.entangle.nodestake.top/addrbook.json

# Service
NODE_SERVICE_NAME=entangle
