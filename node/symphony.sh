...
# Node
NODE_REPO=https://github.com/Orchestra-Labs/symphony.git
NODE_VERSION=v0.5.0
NODE_REPO_FOLDER=symphony
NODE_DAEMON=symphonyd
NODE_ID=symphony-testnet-4
NODE_DENOM=note
NODE_FOLDER=.symphonyd
NODE_GENESIS_ZIP=false
NODE_GENESIS_FILE=https://snapshot.sychonix.com/testnet/symphony/genesis.json
NODE_GENESIS_CHECKSUM=
NODE_ADDR_BOOK=true
NODE_ADDR_BOOK_FILE=https://snapshot.sychonix.com/testnet/symphony/addrbook.json

# Service
NODE_SERVICE_NAME=symphony
...
# Snapshot
SNAPSHOT_PATH=https://snapshot.sychonix.com/testnet/symphony/symphony-snapshot.tar.lz4
...
function downloadSnapshot() {
  ...
  rm -rf $HOME/$NODE_FOLDER/wasm
  rm -rf $HOME/$NODE_FOLDER/ibc_08-wasm
