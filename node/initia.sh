...
# Node
NODE_REPO=https://github.com/initia-labs/initia.git
NODE_VERSION=v0.2.14
NODE_REPO_FOLDER=initia
NODE_DAEMON=initiad
NODE_ID=initiation-1
NODE_DENOM=uinit
NODE_FOLDER=.initia
NODE_GENESIS_ZIP=false
NODE_GENESIS_FILE=https://snapshots.kjnodes.com/initia-testnet/genesis.json
NODE_GENESIS_CHECKSUM=
NODE_ADDR_BOOK=true
NODE_ADDR_BOOK_FILE=https://snapshots.kjnodes.com/initia-testnet/addrbook.json

# Service
NODE_SERVICE_NAME=initia
...
# Snapshot
#SNAPSHOT_PATH=https://snapshots.kjnodes.com/initia-testnet/snapshot_latest.tar.lz4
SNAPSHOT_PATH=https://snapshots-testnet.nodejumper.io/initia-testnet/initia-testnet_latest.tar.lz4
...
function initNode() {
  ...
  # seed
  echo "Setting Seed..."
  SEEDS="3f472746f46493309650e5a033076689996c8881@initia-testnet.rpc.kjnodes.com:17959,2eaa272622d1ba6796100ab39f58c75d458b9dbc@34.142.181.82:26656,c28827cb96c14c905b127b92065a3fb4cd77d7f6@testnet-seeds.whispernode.com:25756"
...
s%:26660%:${NODE_PORT}660%g" $CONFIG_PATH
...
s%:6065%:${NODE_PORT}065%g" $APP_PATH

  # gas
  echo "Setting Minimum Gas..."
  sed -i -e "s|^minimum-gas-prices *=.*|minimum-gas-prices = \"0.15uinit,0.01uusdc\"|" $APP_PATH
...
function downloadSnapshot() {
  ...
  curl -L $SNAPSHOT_PATH | tar -Ilz4 -xf - -C $HOME/.initia
