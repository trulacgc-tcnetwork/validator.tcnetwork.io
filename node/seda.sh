...
NODE_VERSION=v1.0.0-rc.2
NODE_REPO_FOLDER=seda-chain
NODE_DAEMON=sedad
NODE_ID=seda-1-testnet
NODE_DENOM=aseda
NODE_FOLDER=.sedad
NODE_GENESIS_ZIP=false
NODE_GENESIS_FILE=https://snapshots.kjnodes.com/seda-testnet/genesis.json
NODE_GENESIS_CHECKSUM=
NODE_ADDR_BOOK=true
NODE_ADDR_BOOK_FILE=https://snapshots.kjnodes.com/seda-testnet/addrbook.json

# Service
NODE_SERVICE_NAME=seda-testnet
...
# Snapshot
SNAPSHOT_PATH=https://snapshots.kjnodes.com/seda-testnet/snapshot_latest.tar.lz4
...
function initNode() {
  ...
  # seed
  echo "Setting Seed..."
  SEEDS="3f472746f46493309650e5a033076689996c8881@seda-testnet.rpc.kjnodes.com:17359"
