...
# Node
NODE_REPO=https://github.com/Galactica-corp/galactica
NODE_VERSION=v0.2.4
NODE_REPO_FOLDER=galactica
NODE_DAEMON=galacticad
NODE_ID=galactica_9302-1
NODE_DENOM=agnet
NODE_FOLDER=.galactica
NODE_GENESIS_ZIP=false
NODE_GENESIS_FILE=https://server-4.itrocket.net/testnet/galactica/genesis.json
NODE_GENESIS_CHECKSUM=
NODE_ADDR_BOOK=true
NODE_ADDR_BOOK_FILE=https://server-4.itrocket.net/testnet/galactica/addrbook.json

# Service
NODE_SERVICE_NAME=galactica
...
# Snapshot
SNAPSHOT_PATH=https://server-4.itrocket.net/testnet/galactica/galactica_2024-11-09_3188877_snap.tar.lz4
...
function initNode() {
  ...
  # Download addrbook
  echo -e "\e[1m\e[32mDownloading Addressbook File... \e[0m" && sleep 1
...
function installService() {
  ...
  User=$USER
  Type=simple
  ExecStart=$(which $NODE_DAEMON) start --chain-id $NODE_ID
  Restart=on-failure
  RestartSec=3
  LimitNOFILE=65535
...
function createValidator() {
  ...
  $NODE_DAEMON tx staking create-validator \
    --amount 10000000000000000$NODE_DENOM \
