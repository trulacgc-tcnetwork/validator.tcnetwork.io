...
# Node
NODE_REPO=https://github.com/warden-protocol/wardenprotocol.git
NODE_VERSION=v0.3.0
NODE_REPO_FOLDER=wardenprotocol
NODE_DAEMON=wardend
NODE_ID=buenavista-1
NODE_DENOM=uward
NODE_FOLDER=.warden
NODE_GENESIS_ZIP=false
NODE_GENESIS_FILE=https://ss-t.warden.nodestake.org/genesis.json
NODE_GENESIS_CHECKSUM=
NODE_ADDR_BOOK=true
NODE_ADDR_BOOK_FILE=https://ss-t.warden.nodestake.org/addrbook.json

# Service
NODE_SERVICE_NAME=warden
